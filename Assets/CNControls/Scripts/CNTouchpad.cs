...
public class CNTouchpad : CNAbstractController
{
    ...
    public delegate void OnTapHandler(Vector3 vector);
    ...
    {
        Vector3 worldPosition = ParentCamera.ScreenToWorldPoint(capturedTouch.position);
        Vector3 difference = worldPosition - this.gameObject.transform.position;
      difference.Normalize();
    ...
    public Vector3 LastPositionTap { get; set; }
